<div class="grid gap-8 lg:grid-cols-2">
    <div>
        ...
        <div class="mt-6 space-y-4">
            ...
            <flux:button variant="primary" class="w-full" wire:click="addToCart" :disabled="$this->pricing['unit_price'] < 0">
                Tambah ke Keranjang
            </flux:button>
        </div>
    </div>
    ...
    <div>
        <flux:card class="space-y-3">
            ...
            <flux:text class="text-xs">Luas minimal tagihan: {{ $product->min_size_m2 }} m². Harga dihitung real-time.</flux:text>
        </flux:card>
    </div>
</div>
